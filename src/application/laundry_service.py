...
from src.application.services import distribute_order, put_clothes_in_laundrybag #, check_clothes_in_order_is_fully_reclaimed, reclaim_clothes_into_order
    ...
    def run_process(self, order : Order) :
        ...
        for laundrylabel, clothes_list in laundrylabeldict.items() :
            ...
            for clothes in clothes_list :
                laundryBagList = put_clothes_in_laundrybag(waiting_bag, clothes)
